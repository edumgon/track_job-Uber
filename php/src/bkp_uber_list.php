...
try {
    ...
    $hostname = '{mail.infoeg.com.br:993/imap/ssl}INBOX';
    $username = 'contato@infoeg.com.br'; // Replace with your Outlook email
    $password = $pass; // Replace with your password

    $mail->isSMTP();
    $mail->Host = 'mail.infoeg.com.br';
    $mail->SMTPAuth = true;
    ...
    // Reipients
    $mail->setFrom($username, 'InfoEG');
    $mail->addAddress('edumgon@hotmail.com', 'Eduardo Gonçalves');
    $mail->addReplyTo($username, 'InfoEG');
    $mail->isHTML(true);
    $mail->Subject = 'Teste de Envio de E-mail';
    $mail->Body = 'Este é um teste de envio de e-mail usando PHPMailer.';
    $mail->send();
...
if (isset($_POST['login'])) {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        if (in_array($email, $authorized_emails)) {
            ...
            $auth_error = "E-mail não autorizado. Acesso negado.";
        }
    } else {
...
function getUberData() {
    global $conn; // Assumindo que $conn é a conexão criada em database.php
    $conn = DatabaseConnection::getInstance()->getConnection();
    $sql = "SELECT * FROM uber ";
...
if (isset($_GET['renew']) && isValidSession()) {
    $_SESSION['auth_time'] = time();
    header("Location: " . $_SERVER['PHP_SELF']);
    exit;
}
                            ...
                            <form method="post" action="">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text text-muted">
                                        Use apenas e-mails autorizados.
                                    </div>
                                </div>
                                <div class="d-grid">
                                    <button type="submit" name="login" class="btn btn-primary">Acessar Dashboard</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6 text-end">
                    <div class="session-timer">
                        ...
                        <a href="?renew=1" class="btn btn-sm btn-outline-primary ms-2" id="renewBtn">Renovar</a>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function updateTimer() {
                        ...
                        // Alterar cor quando faltar menos de 1 minuto
                        if (timeLeft <= 60) {
